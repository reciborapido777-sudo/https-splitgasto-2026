...
const translations = {
  es: {
    ...
    'activity.yourBalance': 'Tu Balance',
    'activity.youOwe': 'Tus Deudas',
    'activity.toReceive': 'A Recibir',
    'activity.toPay': 'A Pagar',
    'activity.pendingPayment': 'Pendiente de pago',
    'activity.allClear': 'Al día',
    'activity.youOweThem': 'Debes {owed}€ · Te deben {receive}€',
    'activity.youOweTotal': 'Debes {amount}€ en total',
    'activity.theyOweYou': 'Te deben {amount}€ en total',
    'activity.noDebts': 'Sin deudas pendientes',
    'membership.loginRequired': 'Debes iniciar sesión primero',
    'membership.connectingStripe': '⏳ Conectando con Stripe...',
    'membership.paymentError': 'Error iniciando pago',
    'membership.connectionError': 'Error de conexión',
    'membership.ctaYearly': 'Prueba 7 días gratis',
    'membership.ctaMonthly': 'Suscribirme · 2,99€/mes', 
    'group.member': 'Socio',
    ...
    'auth.loginRequired': 'Debes iniciar sesión primero',
    ...
    'split.directSplit': 'Reparto Directo',
  ...
  en: {
    ...
    'activity.yourBalance': 'Your Balance',
    'activity.youOwe': 'You Owe',
    'activity.toReceive': 'To Receive',
    'activity.toPay': 'To Pay',
    'activity.pendingPayment': 'Pending payment',
    'activity.allClear': 'All clear',
    'activity.youOweThem': 'You owe {owed}€ · They owe you {receive}€',
    'activity.youOweTotal': 'You owe {amount}€ total',
    'activity.theyOweYou': 'They owe you {amount}€ total',
    'activity.noDebts': 'No pending debts',
    'membership.loginRequired': 'You must log in first',
    'membership.connectingStripe': '⏳ Connecting to Stripe...',
    'membership.paymentError': 'Error starting payment',
    'membership.connectionError': 'Connection error',
    'membership.ctaYearly': 'Start 7-day free trial',
    'membership.ctaMonthly': 'Subscribe · €2.99/month',
    'group.member': 'Member',
    ...
    'auth.loginRequired': 'You must log in first',
    ...
    'split.directSplit': 'Direct Split',
  ...
  fr: {
    ...
    'activity.yourBalance': 'Votre Solde',
    'activity.youOwe': 'Vos Dettes',
    'activity.toReceive': 'À Recevoir',
    'activity.toPay': 'À Payer',
    'activity.pendingPayment': 'Paiement en attente',
    'activity.allClear': 'À jour',
    'activity.youOweThem': 'Vous devez {owed}€ · On vous doit {receive}€',
    'activity.youOweTotal': 'Vous devez {amount}€ au total',
    'activity.theyOweYou': 'On vous doit {amount}€ au total',
    'activity.noDebts': 'Aucune dette en attente',
    'membership.loginRequired': 'Vous devez d\'abord vous connecter',
    'membership.connectingStripe': '⏳ Connexion à Stripe...',
    'membership.paymentError': 'Erreur lors du lancement du paiement',
    'membership.connectionError': 'Erreur de connexion',
    'membership.ctaYearly': 'Essai gratuit 7 jours', 
    'membership.ctaMonthly': 'S\'abonner · 2,99€/mois',
    'group.member': 'Membre',
    ...
    'auth.loginRequired': 'Vous devez vous connecter',
    ...
    'split.directSplit': 'Partage Direct',
  ...
  de: {
    ...
    'activity.yourBalance': 'Ihr Guthaben',
    'activity.youOwe': 'Ihre Schulden',
    'activity.toReceive': 'Zu Erhalten',
    'activity.toPay': 'Zu Zahlen',
    'activity.pendingPayment': 'Ausstehende Zahlung',
    'activity.allClear': 'Im Gleichgewicht',
    'activity.youOweThem': 'Sie schulden {owed}€ · Man schuldet Ihnen {receive}€',
    'activity.youOweTotal': 'Sie schulden {amount}€ insgesamt',
    'activity.theyOweYou': 'Man schuldet Ihnen {amount}€ insgesamt',
    'activity.noDebts': 'Keine ausstehenden Schulden',
    'membership.loginRequired': 'Sie müssen sich zuerst anmelden',
    'membership.connectingStripe': '⏳ Verbindung mit Stripe...',
    'membership.paymentError': 'Fehler beim Starten der Zahlung',
    'membership.connectionError': 'Verbindungsfehler',
    'membership.ctaYearly': '7 Tage kostenlos testen',
    'membership.ctaMonthly': 'Abonnieren · 2,99€/Monat',
    ...
    'auth.loginRequired': 'Sie müssen sich anmelden',
    ...
    'split.directSplit': 'Direktaufteilung',
  ...
  zh: {
    ...
    'activity.yourBalance': '您的余额',
    'activity.youOwe': '您的欠款',
    'activity.toReceive': '待收',
    'activity.toPay': '待付',
    'activity.pendingPayment': '待付款',
    'activity.allClear': '已结清',
    'activity.youOweThem': '您欠 {owed}€ · 待收 {receive}€',
    'activity.youOweTotal': '您共欠 {amount}€',
    'activity.theyOweYou': '待收 {amount}€',
    'activity.noDebts': '无待处理债务',
    'membership.loginRequired': '请先登录',
    'membership.connectingStripe': '⏳ 正在连接 Stripe...',
    'membership.paymentError': '启动支付时出错',
    'membership.connectionError': '连接错误',
    'membership.ctaYearly': '免费试用 7 天',
    'membership.ctaMonthly': '订阅 · 2.99€/月',
    'group.member': '成员',
    'group.members': '成员',
    'groups.title': '我的群组',
  ...
  ja: {
    ...
    'activity.yourBalance': 'あなたの残高',
    'activity.youOwe': 'あなたの借金',
    'activity.toReceive': '受取予定',
    'activity.toPay': '支払予定',
    'activity.pendingPayment': '支払い待ち',
    'activity.allClear': '清算済み',
    'activity.youOweThem': '{owed}€の支払い · {receive}€の受取',
    'activity.youOweTotal': '合計{amount}€の支払い',
    'activity.theyOweYou': '合計{amount}€の受取',
    'activity.noDebts': '未清算の債務なし',
    'membership.loginRequired': '先にログインしてください',
    'membership.connectingStripe': '⏳ Stripeに接続中...',
    'membership.paymentError': '支払い開始エラー',
    'membership.connectionError': '接続エラー',
    'membership.ctaYearly': '7日間無料お試し',
    'membership.ctaMonthly': '購読 · 2.99€/月',
    'group.member': 'メンバー',
    'group.members': 'メンバー',
    'groups.title': 'マイグループ',
